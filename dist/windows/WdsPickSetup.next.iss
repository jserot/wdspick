...
{ ObsLocPage.Values[0] := GetPreviousData('Name', ExpandConstant('{sysuserinfoname}')); }
{ ObsLocPage.Values[1] := GetPreviousData('Company', ExpandConstant('{sysuserinfoorg}')); }

procedure InitializeWizard;
begin
  { Data input page for specifying observatory location }
  { ObsLocPage := CreateInputQueryPage(wpWelcome, 'Set location of your observatory', '', ''); }
  { ObsLocPage.Add('Latitude ([-]xx.xxxx):', "45.0000"); }
  { ObsLocPage.Add('Longitude ([-]xx.xxxx):', "-3.0000"); }
